...
$consulta = select("atendimento","*","WHERE (rx_torax = '1') OR (rx_torax_oit = '1') OR (rx_cervical = '1') OR (rx_lombar = '1') OR (rx_lombo_sacra = '1') 
  AND dia LIKE '%$dia%' AND mes LIKE '%$mes%' AND ano LIKE '%$ano%'","ORDER BY id ASC");
...
<html lang="pt-BR">
  <head>
    ...
    <meta http-equiv="refresh" content="10000000000;URL=rx_torax.php">

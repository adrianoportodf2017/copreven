...
$consulta = select("atendimento","*","WHERE (ex_clinico = '1') OR (romberg = '1') AND dia LIKE '%$dia%' AND mes LIKE '%$mes%' AND ano LIKE '%$ano%'","ORDER BY id ASC");
...
<html lang="pt-BR">
  <head>
    ...
    <meta http-equiv="refresh" content="100000000000;URL=sala305.php">

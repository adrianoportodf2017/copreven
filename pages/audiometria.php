...
$consulta = select("atendimento","*","WHERE audiometria LIKE 'A' AND dia LIKE '%$dia%' AND mes LIKE '%$mes%' AND ano LIKE '%$ano%'","ORDER BY id ASC");
$consulta2 = select("atendimento","*","WHERE audiometria LIKE 'O' AND dia LIKE '%$dia%' AND mes LIKE '%$mes%' AND ano LIKE '%$ano%'","ORDER BY id ASC");
...
<html lang="pt-BR">
  <head>
    ...
    <meta http-equiv="refresh" content="100000000000;URL=audiometria.php">
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
    
    <title>AUDIOMETRIA | SALA ONLINE | COPREVEN</title>
...
<strong>RELATÓRIO DE ATENDIMENTO - AUDIOMETRIA</strong>
  ...
  <div class="col-md-12">
  	<div class="panel panel-default">
        ...
        <?php
     $clinico = select('atendimento', '*', "WHERE audiometria = 'A' AND dia LIKE '%$dia%' AND mes LIKE '%$mes%' AND ano LIKE '%$ano%' ORDER BY id");
  ...
  <div class="col-md-6">
          <div class="panel panel-default">
            <?php listar_atendimento_salas($consulta, 'audiometria') ?>
          </div>
        </div>

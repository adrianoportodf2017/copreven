      ...
      <div class="row" style="background-color:#F0FFFF">
        ...
        <div class="col-md-2">
          ...
          <font size="3"><i class="fas fa-user-clock"></i> Chegada: <span class="badge badge-success"><?php echo $consulta[$i]['hr_chegada'] ?></span><br>
            <i class="fas fa-history"></i> Saída: <span class="badge badge-secondary"><?php echo $consulta[$i]['hr_saida'] ?></span>
          </font>
          <br>
          <br>
        ...
        <div class="col-md-3">
          <strong><?php echo $consulta[$i]['nome'] ?></strong> <strong><br>
            <h6><span class="badge badge-primary"><?php echo $consulta[$i]['tipo'] ?></span> <span class="badge badge-primary"><?php echo $consulta[$i]['cargo'] ?></span></h6>
          </strong><br>
          ...
          ?>
            <h6>
              <a href="" onclick="window.open('liberar.php?id=<?php echo $consulta[$i]['id'] ?>', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=50, LEFT=50, WIDTH=550, HEIGHT=400');">
                <button type="button" class="btn btn-outline-primary btn-sm">LIBERAR PACIENTE</button></a>
            </h6>
        ...
        <div class="col-md-3">
          <font size="1">
            Status [ <strong>
              <font color="<?php echo $cor_status_clinico ?>"><?php echo $status_clinico ?></font>
            </strong> ] | [<strong><?php echo $tem_clinico ?></strong>]-Ex Clinico<br>
            Status [ <strong>
              <font color="<?php echo $cor_status_romberg ?>"><?php echo $status_romberg ?></font>
            </strong> ] | [<strong><?php echo $tem_romberg ?></strong>]-Romberg<br>
            Status [ <strong>
              <font color="<?php echo $cor_status_raiox ?>"><?php echo $status_raiox ?></font>
            </strong> ] | [<strong><?php echo $tem_raiox ?></strong>]-Raio-x em Geral<br>
            Status [ <strong>
              <font color="<?php echo $cor_status_espiro ?>"><?php echo $status_espiro ?></font>
            </strong> ] | [<strong><?php echo $tem_espiro ?></strong>]-Espirometria<br>
            Status [ <strong>
              <font color="<?php echo $cor_status_audio ?>"><?php echo $status_audio ?></font>
            </strong> ] | [<strong><?php echo $tem_audio ?></strong>]-Audiometria<br>
            Status [ <strong>
              <font color="<?php echo $cor_status_acuidade ?>"><?php echo $status_acuidade ?></font>
            </strong> ] | [<strong><?php echo $tem_acuidade ?></strong>]-Acuidade Visual<br>
            Status [ <strong>
              <font color="<?php echo $cor_status_psico ?>"><?php echo $status_psico ?></font>
            </strong> ] | [<strong><?php echo $tem_psico ?></strong>]-Av. Psicossocial<br>
            Status [ <strong>
              <font color="<?php echo $cor_status_ecg ?>"><?php echo $status_ecg ?></font>
            </strong> ] | [<strong><?php echo $tem_ecg ?></strong>]-ECG<br>
            Status [ <strong>
              <font color="<?php echo $cor_status_eeg ?>"><?php echo $status_eeg ?></font>
            </strong> ] | [<strong><?php echo $tem_eeg ?></strong>]-EEG<br>
            Status [ <strong>
              <font color="<?php echo $cor_status_lab ?>"><?php echo $status_lab ?></font>
            </strong> ] | [<strong><?php echo $tem_lab ?></strong>]-Ex. Laboratoriais<br>
          </font>

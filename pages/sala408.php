...
<strong>RELATÓRIO DE ATENDIMENTO - SALA 408</strong>
  ...
  <div class="col-md-12">
  	<div class="panel panel-default">
        ...
        <?php
        $clinico = $pdo->query("SELECT * FROM atendimento WHERE (rx_torax = '1') OR (rx_torax_oit = '1') OR (rx_cervical = '1') OR (rx_lombar = '1') OR (rx_lombo_sacra = '1') OR (espirometria = '1') AND dia LIKE '%$dia%' AND mes LIKE '%$mes%' AND ano LIKE '%$ano%' ORDER BY id")->fetchAll();

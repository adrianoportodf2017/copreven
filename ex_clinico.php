...
<strong>RELATÓRIO DE ATENDIMENTO - EXAME CLÍNICO</strong>
  ...
  <ul class="list-group">
    ...
    <a href ="#" onclick="window.open('ex_clinico_ok.php?id=<?php echo $consulta[$i]['id'] ?>', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=50, LEFT=50, WIDTH=550, HEIGHT=400');">

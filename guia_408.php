...
<div class="container">
	<div class="row">
		...
		<div class="col-md-12">
			...
			[ <strong><?php echo $tem_torax ?></strong> ] RX-TORAX
            [ <strong><?php echo $tem_oit ?></strong> ] RX-TORAX (OIT)
            [ <strong><?php echo $tem_lombar ?></strong> ] RX-COLUNA LOMBAR
            [ <strong><?php echo $tem_cervical ?></strong> ] RX-COLUNA CERVICAL
            [ <strong><?php echo $tem_sacra ?></strong> ] RX-LOMBO SACRA

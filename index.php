...
<html>
  ...
  <body>
	...
	<div style="background-image: url('images/topo.jpg'); height: 120px;">
		...
		<span style="color: #fffff8; font-family: 'Alegreya Sans', sans-serif; font-size: 15px;"><i class="fas fa-users"></i>&nbsp; Atendimentos no mês: &nbsp;&nbsp;<?php
            ...
            ?>
            <?php print $t_clinico2; ?><br>
            		<span style="color: #B0E0E6; font-family: 'Alegreya Sans', sans-serif; font-size: 17px;">Em espera: <span class="badge badge-warning">
            		<?php
		...
		<div class="row mx-md-n5">
			...
			<div class="col px-md-5"><div class="p-3 border bg-light">
				...
				<p>
					...
					<form class="form-inline" action="relatorio22.php" method="GET">

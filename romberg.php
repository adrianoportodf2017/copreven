...
<strong>RELATÓRIO DE ATENDIMENTO - T. ROMBERG</strong>
  ...
  <div class="col-md-12">
  	<div class="panel panel-default">
        ...
        <?php
        $clinico = $pdo->query("SELECT * FROM atendimento WHERE romberg LIKE 'A'  AND dia LIKE '%$dia%' AND mes LIKE '%$mes%' AND ano LIKE '%$ano%' ORDER BY id")->fetchAll();
  ...
  <ul class="list-group">
    ...
    <a href ="#" onclick="window.open('romberg_ok.php?id=<?php echo $consulta[$i]['id'] ?>', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=50, LEFT=50, WIDTH=550, HEIGHT=400');">
